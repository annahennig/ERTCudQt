...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_qmapcontrol__LayerMapAdapter_t, stringdata) + ofs \
...
const QMetaObject qmapcontrol::LayerMapAdapter::staticMetaObject = {
    { &Layer::staticMetaObject, qt_meta_stringdata_qmapcontrol__LayerMapAdapter.data,
      qt_meta_data_qmapcontrol__LayerMapAdapter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qmapcontrol__LayerMapAdapter.stringdata))
        return static_cast<void*>(const_cast< LayerMapAdapter*>(this));
