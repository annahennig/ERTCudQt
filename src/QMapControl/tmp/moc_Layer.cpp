...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_qmapcontrol__Layer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 33, 0)
    ...
    "qmapcontrol::Layer\0requestRedraw\0\0"
};
...
void qmapcontrol::Layer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Layer::requestRedraw)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject qmapcontrol::Layer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qmapcontrol__Layer.data,
      qt_meta_data_qmapcontrol__Layer,  qt_static_metacall, 0, 0}
};
...
{
    QMetaObject::activate(const_cast< qmapcontrol::Layer *>(this), &staticMetaObject, 0, 0);
}
