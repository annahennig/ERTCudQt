...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_qmapcontrol__GeometryPoint_t, stringdata) + ofs \
...
const QMetaObject qmapcontrol::GeometryPoint::staticMetaObject = {
    { &Geometry::staticMetaObject, qt_meta_stringdata_qmapcontrol__GeometryPoint.data,
      qt_meta_data_qmapcontrol__GeometryPoint,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qmapcontrol__GeometryPoint.stringdata))
        return static_cast<void*>(const_cast< GeometryPoint*>(this));
