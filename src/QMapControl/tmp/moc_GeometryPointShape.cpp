...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_qmapcontrol__GeometryPointShape_t, stringdata) + ofs \
...
QT_MOC_LITERAL(0, 0, 31)
    ...
    "qmapcontrol::GeometryPointShape\0"
};
...
const QMetaObject qmapcontrol::GeometryPointShape::staticMetaObject = {
    { &GeometryPoint::staticMetaObject, qt_meta_stringdata_qmapcontrol__GeometryPointShape.data,
      qt_meta_data_qmapcontrol__GeometryPointShape,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qmapcontrol__GeometryPointShape.stringdata))
        return static_cast<void*>(const_cast< GeometryPointShape*>(this));
